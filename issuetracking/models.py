...
class Project(models.Model):
    ...
    contributors = models.ManyToManyField(
        settings.AUTH_USER_MODEL, through="Contributor", related_name="contributors"
    )
...
class Issue(models.Model):
    ...
    tag = models.CharField(
        max_length=16,
        choices=([("bug", "Bug"), ("task", "Tâche"), ("improvement", "Amélioration")]),
    )
    priority = models.CharField(
        max_length=16,
        choices=([("low", "Faible"), ("normal", "moyenne"), ("high", "Elevée")]),
    )
