...
from issuetracking.views import ProjectViewset, ProjectContributorViewset
from issuetracking.views import ProjectIssueViewset, CommentViewset
from issuetracking.views import UserSignupViewset, UserViewset
...
project_router.register("users", ProjectContributorViewset, basename="projects_users")
